...
import styles from './SpCrudListWebPartWebPart.module.scss';
import * as strings from 'SpCrudListWebPartWebPartStrings';

export interface ISpCrudListWebPartWebPartProps {
  description: string;
}
...
export default class SpCrudListWebPartWebPart extends BaseClientSideWebPart<ISpCrudListWebPartWebPartProps> {
  ...
  public render(): void {
    this.domElement.innerHTML = `
      <div class="${ styles.spCrudListWebPart }">
